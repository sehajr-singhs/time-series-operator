...
parameter-steps leaves it unchanged (18W/22L vs frozen, $p=0.95$) and
at $22\times$ the budget gains only marginally ($p=0.06$), so
pretraining scale --- not tokenization --- currently decides the
head-to-head (fine-tuned Chronos 27--29W/13--11L over the TSO,
...
(18W/22L vs frozen, $p=0.95$; median skill $+22.7$ vs $+35.2$), and even
the $22\times$-budget fine-tune gains only marginally (26W/14L,
$p=0.06$; median $+33.3$). Against the TSO, both fine-tuned checkpoints
retain the frozen model's advantage (27W/13L, $p=0.006$ at the matched
budget; 29W/11L at the generous budget). The
