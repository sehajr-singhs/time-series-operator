...
head-to-head against v9 (13/23, $p=0.34$). A frozen Chronos-t5-small
...
it wins the paired head-to-head against v9 13/23 ($p=0.34$). The
single-seed effect size is modest and the p-value is not significant,
