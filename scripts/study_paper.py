...
head-to-head against v9 (13/23, $p=0.34$). Four-seed replication
confirms the break is not a lucky seed: all four v14 seeds land at
13--14/23 on the shared subset (v9: 12/23; v11 seeds: 12/5/8) with a
positive median skill in every seed ($+2.0$, $+6.4$, $+0.5$, $+1.4$
points vs a negative v9 median), and the pooled 92 seed-series draws
exceed v9's positive rate 53/92 vs 48/92 ($p=0.17$ vs v9's rate,
$p=0.09$ vs chance; best single seed $p=0.047$). The direction is
consistent across every seed; the effect size is moderate and the
pooled test does not reach conventional significance. A frozen Chronos-t5-small
...
$p=0.05$. Pooled over the 92 seed-series draws the positive fraction is
53/92 vs v9's 48/92 ($p=0.17$ vs the v9 rate; $p=0.09$ vs chance;
Wilcoxon on per-series medians $p=0.10$). The single-seed effect size is modest and the p-values are not
